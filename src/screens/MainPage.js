...
const MainPage = () => {
  ...
  const categories = [
    {
      id: "1",
      name: "취미",
      image: require("../../assets/icons/categoriHobby.png"),
    },
    {
      id: "2",
      name: "운동",
      image: require("../../assets/icons/categoriExercise.png"),
    },
    {
      id: "3",
      name: "또래",
      image: require("../../assets/icons/categoriFriend.png"),
    },
    {
      id: "4",
      name: "공부",
      image: require("../../assets/icons/categoriStudy.png"),
    },
    {
      id: "5",
      name: "음악",
      image: require("../../assets/icons/categoriMusic.png"),
    },
    {
      id: "6",
      name: "게임",
      image: require("../../assets/icons/categoriGame.png"),
    },
  ];
  // 더미 데이터
  const meetings = [
  ...
  const latestMeetings = [...meetings].sort(
